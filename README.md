...
where the popup's old Top 10 option went. The tracklist comes from three
...
Spotify's own per-track popularity score; Spotify's dedicated top-tracks
endpoint is only the last resort, because newer client-credentials apps
find it 403-gated. Beneath it, releases group into
